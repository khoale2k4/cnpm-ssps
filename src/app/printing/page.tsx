...
export default function MuaTrangIn() {
    ...
    const isAttributesDisabled = selectedFiles.length === 0;
                    ...
                    <div className="grid grid-cols-2">
                        <div className="p-2">
                            {renderSelect(
                                ...
                                paperSizeOptions,
                                selectedPaperSize,
                                handleSelectChange(setSelectedPaperSize)
                            )}
                            {renderSelect(
                                "Kiểu in",
                                printModeOptions,
                                selectedPrintMode,
                                handleSelectChange(setSelectedPrintMode)
                            )}
                            <div className="p-2 m-1">
                            ...
                            {renderSelect(
                                ...
                                printerOptions,
                                selectedPrinter,
                                handleSelectChange(setSelectedPrinter)
                            )}
                        </div>
                        ...
                        <div className="p-2">
                            {renderSelect(
                                ...
                                orientationOptions,
                                selectedOrientation,
                                handleSelectChange(setSelectedOrientation)
                            )}
                            <div className="p-2 m-1">
            ...
            {showModal && (
                <div className="fixed inset-0 bg-gray-600 bg-opacity-50 flex justify-center items-center">
                    <div className="bg-white p-6 rounded shadow-lg text-center">
                        <p className="text-xl font-bold">Đơn in đã được gửi!</p>
                        <button
